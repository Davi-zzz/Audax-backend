...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    sku: 'TEC-MECH-01',
    name: 'Teclado Mecânico RGB',
    description: 'Teclado mecânico com switches azuis táteis, iluminação RGB customizável e layout ABNT2.',
    stock: 45,
  ...
  },
  {
    ...
    sku: 'MOU-GAME-02',
    name: 'Mouse Gamer Premium',
    description: 'Mouse gamer ergonômico com sensor de 16.000 DPI, 8 botões programáveis e pesos ajustáveis.',
    stock: 120,
  ...
  },
  {
    ...
    sku: 'MON-CURV-03',
    name: 'Monitor UltraWide 34"',
    description: 'Monitor curvo de 34 polegadas com taxa de atualização de 144Hz, HDR400 e painel IPS de alta fidelidade cromática.',
    stock: 12,
...
export const DOCUMENTATION_DATA = {
  header: {
    ...
    description: "Este documento detalha as decisões de design, escolhas arquiteturais, ferramentas utilizadas e estratégias de validação adotadas para o desenvolvimento deste projeto de cadastro de produtos."
  },
  sections: [
    {
      id: "architecture",
      title: "🏗️ Arquitetura e Decisões de Design",
      description: "O projeto foi estruturado com base nas melhores práticas do React moderno utilizando TypeScript e Tailwind CSS para garantir máxima manutenibilidade, extensibilidade e desempenho.",
      items: [
        {
    ...
    },
    {
      ...
      description: "Como se trata de um teste de interface cliente-side responsivo, as escolhas de estado priorizaram a reatividade e a persistência sem infraestrutura complexa.",
      items: [
        {
    ...
    },
    {
      ...
      description: "A validação em tempo real é um dos pilares de UX deste projeto, prevenindo erros de entrada antes mesmo que o usuário tente submeter o formulário.",
      items: [
        {
    ...
    },
    {
      ...
      description: "As tecnologias foram selecionadas para fornecer uma experiência de desenvolvimento rápida e um produto final de alto desempenho.",
      items: [
        {
